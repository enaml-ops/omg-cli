...
--ssl-ignore \
--print-manifest \
vsphere-cloudconfigplugin-osx --az z1 \
--az z2 \
--az z3 \
--network-name-1 bosh \
--network-az-1 z1 \
...
--vsphere-network-name-1 test-vnet \
...
--network-static-2 10.0.0.72,10.0.0.73 \
--network-static-2 10.0.0.74,10.0.0.75 \
--vsphere-network-name-2 test-vnet
