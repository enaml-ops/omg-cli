...
*/
	...
	/*Diego - Descr: Address of the auctioneer API Default: http://auctioneer.service.cf.internal:9016
*/
	Diego *Diego `yaml:"diego,omitempty"`

	/*Etcd - Descr: maximum number of idle http connections Default: <nil>
*/
