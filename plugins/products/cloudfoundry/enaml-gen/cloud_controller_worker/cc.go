...
*/
	...
	/*Newrelic - Descr: Capture and send query params to NewRelic Default: false
*/
...
*/
	...
	/*ResourcePool - Descr: Directory (bucket) used store app resources.  It does not have be pre-created. Default: cc-resources
*/
